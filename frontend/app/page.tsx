          ...
          >
            ...
            <div
              style={{
                ...
                borderBottom: isDark ? "1px solid #111827" : "1px solid #e2e8f0",
                display: "flex",
                alignItems: "center",
            ...
            <div style={{ padding: "12px 14px 14px" }}>
              ...
              >
                ...
                <span style={{ fontSize: "13px", fontWeight: 700, color: isDark ? "#f1f5f9" : "#0f172a" }}>
                  {selectedEarthquake.depth} Km
                </span>
              </div>
              <p style={{ fontSize: "11px", color: isDark ? "#6b7280" : "#94a3b8" }}>
